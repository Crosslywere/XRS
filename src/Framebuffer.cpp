...
namespace xrs
{
  ...
  Framebuffer::Framebuffer(int width, int height, unsigned int colorBufferCount, const BufferConfigFlags bufferConfigFlags)
      ...
      m_HasDepthBuffer{static_cast<bool>(bufferConfigFlags & (BufferConfigFlags::DEPTH_RENDER_BUFFER |
        BufferConfigFlags::DEPTH_TEXTURE_BUFFER | BufferConfigFlags::DEPTH_TEXTURE_3D_BUFFER))}
  {
    if (m_HasDepthBuffer)
